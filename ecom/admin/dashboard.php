                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <img
                          ...
                          src="<?php echo asset("/assets/admin/img/user1-128x128.jpg") ?>"
                      ...
                      <div class="direct-chat-msg end">
                        ...
                        <img
                          class="direct-chat-img"
                          src="<?php echo asset("/assets/admin/img/user3-128x128.jpg") ?>"
                          alt="message user image"
                        />
                        <!-- /.direct-chat-img -->
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?php echo asset("/assets/admin/img/user7-128x128.jpg") ?>"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?php echo asset("/assets/admin/img/user5-128x128.jpg") ?>"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?php echo asset("/assets/admin/img/user6-128x128.jpg") ?>"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?php echo asset("/assets/admin/img/user8-128x128.jpg") ?>"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
