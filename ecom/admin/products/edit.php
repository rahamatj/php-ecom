...
try {
    ...
    if (isset($_GET['id'])) {
        ...
        $get_product_sql = "SELECT * FROM products WHERE id = :id";
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE products SET name = :name, price = :price, category_id = :category_id, description = :description, image = :image, stock = :stock, is_active = :is_active WHERE id = :id";
            ...
            <div class="app-content">
                ...
                <div class="container-fluid">
                    <div class="card card-info card-outline mb-4">
                        ...
                        <!--end::Header-->
                        <!--begin::Form-->
                        <form id="edit-product-form" novalidate method="POST" enctype="multipart/form-data">
                            <!--begin::Body-->
                            <div class="card-body">
                                <!--begin::Row-->
                                <div class="row g-3">
